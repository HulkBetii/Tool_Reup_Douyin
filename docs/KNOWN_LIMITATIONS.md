...
6. Voice policy theo quan he/nhan vat da co layer rieng cho preset resolution, nhung chua map register/role -> speaking style hay prosody control.
...
- Voice policy should preserve four precedence/fail-safe rules:
